...
public class TestBase {
	...
	public TestBase()
	{
		try {
			...
			FileInputStream ip = new FileInputStream("C:\\Users\\mahenderd\\eclipse-workspace\\MavenprojectGTK\\KonnectPortal\\src\\main\\java\\com\\konnect\\config\\config.properties");
			prop.load(ip);
	...
	public static void initialization()
	{
		...
		{
			System.setProperty("webdriver.chrome.driver", "C:\\Seleniumdrivers\\chromedriverx32.exe");	
